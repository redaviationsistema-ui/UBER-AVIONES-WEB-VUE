...
.metric-card--warning {
  background: linear-gradient(180deg, #fff8ef, #fff1d9);
}

.metric-card--danger {
  background: linear-gradient(180deg, #fff3f1, #ffe5e0);
}
...
.crew-table-row {
  display: grid;
  grid-template-columns: 1.3fr 0.72fr 0.72fr 0.85fr 1.15fr 0.95fr 0.7fr 1.45fr;
  align-items: start;
  gap: 0.8rem;
  min-width: 84rem;
  padding: 1rem;
...
.crew-table-row + .crew-table-row,
.crew-calendar-row + .crew-calendar-row {
...
.crew-name-cell small,
.crew-cert-cell small,
.crew-rating-cell small {
  color: #70675a;
}
...
.crew-skeleton-row span {
  height: 3rem;
  border-radius: 16px;
  background: linear-gradient(90deg, #f4eee3 0%, #fbf7f0 50%, #f4eee3 100%);
}
...
.crew-calendar-row {
  display: grid;
  grid-template-columns: minmax(12rem, 1.15fr) repeat(7, minmax(7rem, 1fr));
  gap: 0.7rem;
  align-items: stretch;
  min-width: 72rem;
  padding: 1rem;
...
.crew-calendar-head .is-today {
  border-color: #111111;
}

.crew-calendar-cell[data-tone='success'] {
  background: #eefbf1;
}

.crew-calendar-cell[data-tone='info'] {
  background: #e8f1ff;
}

.crew-calendar-cell[data-tone='warning'] {
  background: #fff1d9;
}

.crew-calendar-cell[data-tone='danger'] {
  background: #ffe5e0;
}
