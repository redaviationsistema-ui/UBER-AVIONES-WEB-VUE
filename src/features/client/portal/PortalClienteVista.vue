  ...
  <div class="client-app-shell">
    ...
    <main class="client-page">
      ...
      <PortalClienteTripsScreen
        ...
        :flight-brief-error="flightBriefError"
        :flight-brief-refresh-error="flightBriefRefreshError"
        :flight-brief-loading="flightBriefLoading"
        ...
        @retry-flight-brief="retryFlightBrief"
