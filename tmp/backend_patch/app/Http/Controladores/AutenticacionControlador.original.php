...
class AutenticacionControlador extends ControladorBase
{
    ...
    private function loadAuthUser(Usuario $user): Usuario
    {
        $relations = $this->usesSlimClientAuthPayload($user)
            ? [
                'profile:id,user_id,client_type,company_name,business_type,tax_id,country,city,base_airport,base_airport_id,address,avatar,avatar_url,tax_data,birth_date,nationality,document_type,document_number,document_issuing_country,identity_validation_required,ine_curp,ine_cic,ine_ocr,ine_scan_raw,ine_scan_status,ine_front_path,ine_back_path',
    ...
    private function serializeAuthUser(Usuario $user): array
    {
        ...
        $basePayload = [
            ...
            'profile' => $profile ? [
                ...
                'document_issuing_country' => $profile->document_issuing_country,
